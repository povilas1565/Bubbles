    ...
    public sealed class UpdateManager : IDisposable
{
    ...
    public void Add(object updatable)
    {
      ...
      if (updatable is FixedTickable fixedTick) _component.FixedTicks.Add(fixedTick);  
    }
   ...
   public void Remove(object updatable) 
    {
      ...
      if (updatable is FixedTickable fixedTick) _component.FixedTicks.Remove(fixedTick);  
    }
